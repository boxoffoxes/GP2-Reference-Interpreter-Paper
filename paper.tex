...
\author{Christopher Bak\thanks{The first two authors are supported by grants from the Engineering and Physical Sciences Research Council.},\hspace{.2em} Glyn Faulkner\footnotemark[1],\hspace{.2em} Detlef Plump and Colin Runciman
\institute{Department of Computer Science, The University of York, UK}
}
...
\input{benchmark}
\input{usesrequirements}
\input{03_implementation}
\input{04_results}
\input{05_discussion}

\bibliography{abbr,bibliography}{}
